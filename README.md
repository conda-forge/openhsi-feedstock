...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/openhsi-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15646&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/openhsi-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `openhsi` can be installed with:

```
conda install openhsi
```

It is possible to list all of the versions of `openhsi` available on your platform with:
